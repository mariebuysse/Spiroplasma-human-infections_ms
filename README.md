...
For each sample, a set of paired-end reads is available in NCBI (SRA: SRR34699693 & SRR34699694). Details about the experimental and sequencing methods are available in the related manuscript.
